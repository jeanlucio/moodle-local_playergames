...
class mykeys {
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        return [
            ...
            'openai_url'               => api_key_helper::get_personal_openai_url($this->userid),
            'openai_url_placeholder'   => api_key_helper::get_openai_baseurl(),
            'openai_model_label'       => get_string('settings_openai_model', 'local_playergames'),
            'openai_model'             => api_key_helper::get_personal_openai_model($this->userid),
            'openai_model_placeholder' => api_key_helper::get_openai_model(),
