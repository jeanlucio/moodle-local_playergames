...
$string['cartridge_uploaded'] = 'Enviado em';
...
$string['error_no_ai_key'] = 'Nenhuma chave de IA configurada. Adicione uma chave nas configurações de Chaves de API de IA. {$a}';
